...
datagen = ImageDataGenerator(
    featruewise_center=False, # set input mean to 0 over the dataset
    ...
    width_shift_range=0.15, # randomly shift images horizontally (fraction of total widht)
    height_shift_range=0.1, # randomly shift images veritcally (fraction of total heigth)
...
x = layers.GlobalAveragePooling2D(name="avg_pool")(model.input)
...
layers = [op.name for op in frozen_func.grap.get_operations()]
print("-"*50)
